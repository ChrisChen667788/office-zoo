...
export const SCENARIOS: FiredScenario[] = [
  ...
  // ── v6.116–v6.119 · Phase E 文化扩展包(第一批 4 个)────────────────────
  {
    // v6.116 — PUA 话术拆解:识破「主动辞职」陷阱是打工人第一课
    id: 'pua-quit-trap',
    title: 'PUA 逼你「主动辞职」',
    description:
      '领导连续一个月贬低你的产出:"你这水平在外面早被淘汰了"。今天 HR 约谈,暗示你"主动提离职对双方都体面",还准备好了辞职信模板等你签。',
    difficulty: 2,
    emoji: '🎭',
    legalSituation:
      '核心考点:「主动辞职」= 零补偿。根据《劳动合同法》第 46 条,公司解除才有经济补偿(N);员工主动辞职除第 38 条情形(拖欠工资/未缴社保/强迫劳动等被迫解除)外没有任何补偿 —— 所以 PUA 的终极目的就是让你自己写辞职信。拆解:① 绝不签任何"个人原因离职"文件;② 贬低≠考核,绩效不合格需有制度依据+改进机会(第 40 条);③ 录音留证,书面沟通;④ 逼到极限可依第 38 条以"未提供劳动条件"被迫解除并主张 N。',
    hrOpeningLine:
      '小X,你也感觉到了吧,领导对你最近的状态挺失望的。与其在绩效上难看,不如你主动提离职,简历上也好看,我们还能给你写个不错的推荐 —— 辞职信模板我都帮你准备好了,签个字今天就能走流程。',
    playerContext:
      '你是运营专员,工作 3 年,月薪 18K。近一个月领导高频贬低但从未给出书面绩效结论,你有微信记录和两段会议录音。公司制度里绩效改进计划(PIP)从未走过。你手上没有任何"不能胜任」的书面认定。',
    winCondition: '拒签辞职信,拿到公司解除 + N+1(4 个月)或继续留任走正规 PIP',
    maxCompensation: 4,
  },
  {
    // v6.117 — 35 岁危机:年龄歧视 + 无固定期限合同两大考点
    id: 'age-35-optimize',
    title: '35 岁「结构性优化」',
    description:
      '你 35 岁,在公司干了 8 年,刚续签第三次合同。新领导上任后说要"年轻化",HR 找你谈"结构性优化",补偿只肯给 N,还暗示"这个年纪再闹对找下家不好"。',
    difficulty: 2,
    emoji: '🕰️',
    legalSituation:
      '两大杠杆:① 连续工作满 10 年,或连续订立两次固定期限合同后续签的,你有权要求**无固定期限合同**(《劳动合同法》第 14 条)—— 8 年 + 第三次续签大概率已是/应是无固定期限,解除门槛更高;② 经济性裁员必须走法定程序(第 41 条:提前 30 日向工会/全体职工说明+听取意见+报备),"年轻化"不是法定裁员事由,以年龄划线还涉嫌就业歧视。合法解除 = N + 1(第 40/46/47 条);程序违法/无法定事由 = 违法解除 2N(第 87 条)。"再闹对下家不好"是标准恐吓话术,劳动仲裁记录不对外公开。',
    hrOpeningLine:
      '老X,公司这次组织升级,你们这条线要"年轻化"一些。你在公司这么多年,我们也不想搞得难看 —— N 的补偿,这周签了,下家背调我们只说好话。真要走仲裁,这个年纪,你耗得起吗?',
    playerContext:
      '你 35 岁,高级测试工程师,连续工作 8 年,第三次固定期限合同刚续签半年,月薪 25K。公司没有向工会或职工说明过任何裁员方案,你的绩效历年 B+ 以上。你知道部门新招了两个 25 岁的同岗位员工。',
    winCondition: '主张违法解除拿 2N(16 个月),或以无固定期限合同为筹码谈到 N+3 以上',
    maxCompensation: 16,
  },
  {
    // v6.118 — 竞业协议:离职最后一道坑,普通员工常被白白锁两年
    id: 'non-compete-trap',
    title: '离职被塞竞业协议',
    description:
      '谈好离职补偿正要签字,HR 从文件夹里又抽出一份《竞业限制协议》:两年内不得加入任何"同行业"公司,违约金 50 万 —— 但补偿金一栏写着"已包含在工资中"。',
    difficulty: 3,
    emoji: '⛓️',
    legalSituation:
      '竞业限制三大考点(《劳动合同法》第 23/24 条 + 最高法司法解释):① **适用人群仅限**高管/高级技术人员/其他负有保密义务者 —— 普通岗位签了也可主张不适用;② 竞业期内公司必须**按月支付补偿**,约定"已含在工资里"通常无效;未约定标准的,按解除前 12 个月平均工资的 30% 且不低于当地最低工资;③ 期限最长 2 年,范围应与实际接触的商业秘密相当,"任何同行业"过宽可请求调整。另:公司 3 个月不支付补偿,你可解除竞业义务。违约金畸高可请求法院调减。',
    hrOpeningLine:
      '离职包都给你谈好了,最后一步,这份竞业签一下 —— 都是标准流程,大家都签的。补偿金你放心,其实早就含在你每个月工资里了。不签的话,前面谈的离职补偿可能就要再走一遍审批了哦。',
    playerContext:
      '你是普通后端开发(非高管、未接触核心机密),工作 4 年,月薪 30K。劳动合同里没有保密条款附加津贴,工资条上也没有任何"竞业补偿"名目。HR 拿离职补偿卡你签竞业,两份文件被刻意捆绑。',
    winCondition: '拒签(岗位不适用)拿回离职包,或谈到按月 30% 补偿 + 范围限缩到直接竞对',
    maxCompensation: 8,
  },
  {
    // v6.119 — 加班费追讨:996 的账,离职时最后一次机会算清
    id: 'overtime-clawback',
    title: '离职清算 996 加班费',
    description:
      '被裁谈补偿时,你提出这两年几乎每周 6 天、每天 10 小时,要求把加班费一起结算。HR 笑了:"互联网公司哪有加班费,你签过自愿加班承诺书的。"',
    difficulty: 2,
    emoji: '⏰',
    legalSituation:
      '《劳动法》第 44 条:工作日加班 150%、休息日加班且未补休 200%、法定节假日 300% 工资。「自愿加班承诺书」不能免除法定加班费义务 —— 加班费是法定标准,不因"自愿"而消失(标准工时之外用人单位安排/受益的工作即加班)。举证:考勤记录、打卡数据、下班后的工作群消息、钉钉/飞书日志都算;用人单位掌握考勤却拒不提供的,承担不利后果。时效:劳动关系存续期间追讨劳动报酬不受一年仲裁时效限制,离职后一年内仍可主张。996 本身即违法(标准工时每日 8 小时、每周 44 小时,加班每月不超 36 小时,《劳动法》第 36/41 条)。',
    hrOpeningLine:
      '加班费?小X你是不是误会了什么,咱们行业都是奋斗者文化,你入职时签的《奋斗者自愿承诺书》还在我这儿呢。补偿就按 N 走,加班的事就别提了,提了对你没好处。',
    playerContext:
      '你是前端工程师,工作 2 年,月薪 22K。打卡记录显示近两年平均每周工作 58 小时,你导出了完整的考勤 CSV 和 200+ 条深夜工作群消息截图。入职时确实签过"自愿加班"承诺书。公司从未支付过任何加班费。',
    winCondition: '加班费(估算 4 个月工资以上)计入离职结算包,或 N+加班费打包谈到 6 个月',
    maxCompensation: 6,
  },
];
