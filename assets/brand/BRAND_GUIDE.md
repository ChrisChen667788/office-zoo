...
| `assets/brand/logo-horizontal-lockup-final.png` | 16:9 (1280×720) | 横版 banner v1 · 已归档 (README 现用 v2) | 右侧大字 OFFICE ZOO (gold→pink→violet) + 班味剧场副标 + tagline |
| `assets/brand/logo-readme-banner.png` | 16:9 (1280×720) | **✅ 横版 banner v2 · README 现用** | 同 base + Arial Black 更大字 OFFICE ZOO (gold→amber gradient + drop shadow) + 双 tagline (CN "班味剧场 · 0 点的写字楼" 上 / EN "Midnight Workplace Soap Opera" 下), v6.24 P4 |
