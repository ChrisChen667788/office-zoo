...
## 当前位置(v6.121 · 2026-06 刷新)

> 早期 `0.x`/`1.x` 序号在 v6 大版本线启动后已停用;实际版本走 `v6.x` 逐版迭代
> (完整记录见 [`CHANGELOG.md`](./CHANGELOG.md),v6.55–v6.121 共 60+ 版)。

**Phase 完成度对照(对齐 ITERATION_PLAN 七阶段):**

- ✅ **Phase A · Viral 短视频引擎** — 客户端录制 + ffmpeg 转码 + 高光挑选 + 分享文案(v0.3-0.4 线完成)
- ✅ **Phase B · 记忆 + 反思层** — pgvector 记忆流 + reflection + 跨局关系网/恩怨录(v5.x + v6.75)
- 🚧 **Phase C · 真人玩家加入** — 旁观者已能爆料(PSYWAR)/下注/干预真改剧情(v6.25/74/83);
  「真人占角色位」的房间机制未做,是七阶段唯一整块缺口
- ✅ **Phase D · UGC 平台** — 段子投稿/审核/月度精选 + 公司主题包 + 闯关包(v0.8-0.9 + v6.1/6.37)
- 🚧 **Phase E · 文化扩展包** — 裁了么 27+4 场景(v6.116-119 补 PUA/35 岁/竞业/加班费),持续季度交付
- ✅ **Phase F · 商业化基础** — Premium Pack + Stripe(test-mode)+ B2B 白标(v1.0/1.1 线)
- 🚧 **Phase G · 国际化** — 四语言 UI 字典 + README.en 已有;EN prompt set / HN 首发未做

**近期主线(v6.86–v6.121):** 双公司对抗玩法 → 多 agent 优化审计 P0/P1/P2 全清 →
Z 世代视觉升级(米哈游化 + 立绘体系)→ 审计余项 20 轮清仓。
