...
- ✅ **v6.60 → v6.61** 深层界面图标 emoji→AI:9 张 nav 二次元图标 + 接入**首页二级入口 + 占卜/单口/周报/裁了么/Premium/酒馆/测试/攒局/周年/我的**所有 headline 图标;`<Icon>` 带 emoji 兜底

**下一步(开放讨论):**
- [ ] 牌局 UI 的预算/耐心/筹码/话术卡再生成配套小图标(深层页 headline 已扫完)
