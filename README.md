...
- 🧪 **质量** — 327 vitest 全绿 · typecheck 干净 · Playwright 视觉探针验证 wrapped 卡 + 动画架构图
...
- ✅ **v6.60** 深层界面图标 emoji→AI(首批):9 张 nav 二次元图标(单口/占卜/周报/测试/攒局/Premium/酒馆/周年/我的)+ 接入首页二级入口 / 班味占卜大图标 / 单口·周报页头;`<Icon>` 带 emoji 兜底

**下一步(开放讨论):**
- [ ] **图标 sweep 续**:Premium / 深夜酒馆 / quiz / squad / 周年 等剩余深层页按 `navIcons` 模式接上;牌局 UI 的预算/耐心/筹码/话术卡再生成配套图标
- [ ] 牌局打磨:抽牌/手牌上限(真 roguelike 牌库感)· 遗物多选 + 商店 · 赔偿阶梯结算分享卡
