...
## 🌟 v6.86 → v6.122 升级 · 双公司商战 + 观众真上桌 + Z 世代换皮

> 两家公司同台互卷、观众下注/干预/带节奏真的改剧情、整站米哈游化 —— 这一波把「看戏」升级成「入局」。

- ⚔️ **双公司对抗模式**(v6.85→v6.93)— 4v4 两家公司同台,各藏 1 内鬼:市占率竞速「对撞条」、
  跨司**挖角跳槽**(内鬼身份带走)、**商业抹黑曝料**(真假参半的舆论战)、公司战报分享卡;
  终局矩阵 垄断 > 团灭 > 双鬼皆裁 > 回合上限
- 🎰 **观众经济全闭环**(v6.93→v6.96)— 鬼魂票+你的「🤥 在演」判断**实时改赔率**;干预道具被拒
  **退筹码给真实原因**;结算流水可回看;下注盘移动端贴底 sheet;断线可见条幅
- 🎨 **Z 世代视觉升级**(v6.98→v6.101)— 对局/段子/裁了么全线 **gradient mesh** + 相位随节奏换
  **元素色**(冷蓝待机→红全员会→粉撕逼→金投票)+ Landing **六边形 stigma 卡**;GameMap 居中重排、
  房间色与阵营色解耦
- 🖼️ **立绘体系补完**(v6.98→v6.100)— **24 张职场 archetype 二次元立绘**(班味卡 hero 真显)+
  裁了么**三档黑心 HR 反派立绘**(菜鸟/老油条/魔鬼)+ 段子第 7 位 persona「😎 整顿王」(00 后整顿职场);
  活立绘图生视频管线就绪(MiniMax 海螺 i2v)
- ⚖️ **裁了么 Phase E 场景包**(v6.116→v6.119)— PUA 逼「主动辞职」/ 35 岁「结构性优化」/
  离职被塞竞业协议 / 996 加班费清算 —— 每关都是一堂劳动法速通课
- 🧪 **三轮多 agent 对抗审计全清**(v6.93/95-97/102-122)— 玩法/视觉/UX/性能 40+ 确认项落地:
  新手引导补全、裁员卡可跳过、心理战 chip 化、恩怨录红点、内部邮件专属浮卡、误关页确认……
  549 vitest 全绿 · 首屏主包 −56%(路由级分包)
...
- 🧪 **质量** — 530 vitest 全绿 · typecheck 干净 · Playwright 视觉探针验证 wrapped 卡 + 动画架构图
...
- ✅ **v6.85-v6.86** 双公司对抗·引擎 + 演出层:`shared/dual` 纯引擎(公司分配/市占率竞速/挖人吃关系网/终局矩阵,+27 测试)+ 对撞条/公司徽标/挖角 banner/双司开除演出
- ✅ **v6.87-v6.89** 双公司闭环:双司下注盘 + 猎头快递道具 + 公司战报卡 / 回放补双司字段 / **商业抹黑曝料**(真假参半舆论战,舆论票折进计票)
- ✅ **v6.90-v6.93** 健壮性 + 观众闭环:players 去重 + ErrorBoundary 堵白屏 / 对撞条活化 / 路由分包主包 −56% / 鬼魂票热度改赔率 + 干预回执退筹码 + 断线条幅 + 进局骨架
- ✅ **v6.94** 段子「活立绘」图生视频管线(MiniMax 海螺 i2v,循环微表情;客户端三层回退)
- ✅ **v6.95-v6.97** 审计 P1/P2:新手引导 4 步(下注/干预/双公司上引导)/ 讨论期「在演」存疑改赔率 / 下注盘移动端 sheet / 右栏去重 / 双公司数值平衡(竞速/团灭阈值/抹黑压力)
- ✅ **v6.98-v6.101** Z 世代视觉升级:对局/段子/裁了么 mesh + 元素色相位 + Landing 六边形卡 / **24 张 archetype 立绘** + **3 档 HR 反派立绘** / GameMap 居中重排 + 房间色解耦 + badge 重排
- ✅ **v6.100** 段子第 7 位 persona「😎 整顿王」(00 后整顿职场,全链路接入)
- ✅ **v6.102-v6.122** 审计余项 20 版清仓 + 4 维对抗审查修复:裁员卡可跳过 / 误关页确认 / 结算流水 / 内部邮件浮卡 / 恩怨录红点 / 心理战 chip 化 / free_roam 15s / **裁了么 Phase E 四场景**(PUA/35 岁/竞业/加班费)/ 模式分级 chip / 计划文档刷新
