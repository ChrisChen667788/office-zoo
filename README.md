...
- 🧪 **质量** — 503 vitest 全绿 · typecheck 干净 · Playwright 视觉探针验证 wrapped 卡 + 动画架构图
...
- 🚧 **v6.85 P1** 双公司对抗·纯引擎(设计拍板:4+4/内鬼带身份/~15min):`shared/dual` —— 公司分配(各 1 内鬼)/市占率竞速(节奏护栏锁 ≤8 轮)/挖人概率吃关系网/跳槽喂 backstab/终局矩阵(垄断>团灭>双鬼皆裁>回合上限),+16 测试)+ **P2 接 GameEngine**(mode 开关/双司分配/夜杀限同司/投票分组双裁/市占率终局矩阵/跨司挖人吃关系网,+11 集成测试);引擎跑通,演出层 v6.86
